...
//        self.backgroundColor = UIColor.greenColor;
        ...
        for (NSInteger i = 0; i <  items.count; i ++) {
            ...
            UIView * itemView = [self createBtnViewWithRect:CGRectMake(i*itemWidth, 0, itemWidth, CGRectGetHeight(frame)) imgName:imgName imgHeight:kH_LABEL title:dict[BN_ItemTitle] titleColor:titleColor type:type];
            itemView.tag = kTAG_VIEW + i;
            
 
            CALayer * layer = [itemView createLayerType:@3 color:UIColor.lineColor width:1 paddingScale:0.2];
