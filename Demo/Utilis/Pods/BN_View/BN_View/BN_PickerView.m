...
#import "BN_PickerView.h"

#import "BN_Globle.h"

#define kH_NaviagtionBar 44
#define kH_PickerViewHeight 180


@interface BN_PickerView ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
- (instancetype)initWithPickerData:(NSArray *)array type:(NSNumber *)type cancelBtnTitle:(NSString *)cancelBtnTitle confirmBtnTitle:(NSString *)confirmBtnTitle
{
    ...
    if (self) {
        ...
        CGFloat height = kH_PickerViewHeight + kH_NaviagtionBar + lineHeight;
...
-(UIPickerView *)pickerView{
    if (!_pickerView) {
        _pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, kH_NaviagtionBar+1, CGRectGetWidth(self.containView.frame), kH_PickerViewHeight)];
