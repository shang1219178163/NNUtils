...
static NSTimeInterval kAnimationDuration = 20;

@interface BN_CycleView ()
...
- (void)start{
    ...
    _timer = [NSTimer BN_timeInterval:kAnimationDuration block:^(NSTimer *timer) {
        [self handleActionTimer];
