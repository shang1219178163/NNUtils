...
-(UIImageView *)imgViewArrow{
    if (!_imgViewArrow) {
         ...
         _imgViewArrow = [UIView createImgViewWithRect:CGRectZero image:imageArrow tag:kTAG_IMGVIEW type:@0];
...
-(UIImageView *)imgViewLeft{
    if (!_imgViewLeft) {
        _imgViewLeft = [UIView createImgViewWithRect:CGRectZero image:self.image tag:kTAG_IMGVIEW+1 type:@0];
...
-(UILabel *)labelTitle{
    if (!_labelTitle) {
        _labelTitle = [UIView createLabelWithRect:CGRectZero text:self.title textColor:nil tag:kTAG_LABEL type:@0 font:14 backgroudColor:UIColor.clearColor alignment:NSTextAlignmentLeft];
...
-(UILabel *)labelTitleSub{
    if (!_labelTitleSub) {
        _labelTitleSub = [UIView createLabelWithRect:CGRectZero text:self.title textColor:nil tag:kTAG_LABEL+1 type:@0 font:14 backgroudColor:UIColor.clearColor alignment:NSTextAlignmentLeft];
