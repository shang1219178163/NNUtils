...
-(void)layoutSubviews{
    ...
    for (NSInteger i = 0; i< _items.count; i++) {
        ...
        switch ([_type integerValue] ) {
            case 0://uibutton
            {
                view = [UIView createBtnWithRect:itemRect title:title font:15 image:nil tag:kTAG_VIEW+i type:@11 target:nil aSelector:nil];
            ...
            case 1://UIImageVIew
            {
                ...
                [view addActionHandler:^(id obj, id item, NSInteger idx) {
                    ...
                    [_selectedList replaceObjectAtIndex:idx withObject:@(((UIImageView *)item).selected)];
                    [self hanleActionView:item isSingle:self.isSingle];
            ...
            case 2://UILabel
            {
                ...
                [view addActionHandler:^(id obj, id item, NSInteger idx) {
                    ...
                    [_selectedList replaceObjectAtIndex:idx withObject:@(((UILabel *)item).selected)];
                    [self hanleActionView:item isSingle:self.isSingle];
