...
-(void)createItemView{
    ...
    for (NSInteger i = 0; i < _titleList.count; i++) {
        UILabel * label = [UIView createLabelWithRect:CGRectZero text:_titleList[i] textColor:nil tag:kTAG_LABEL+i type:@0 font:15 backgroudColor:UIColor.randomColor alignment:NSTextAlignmentCenter];
