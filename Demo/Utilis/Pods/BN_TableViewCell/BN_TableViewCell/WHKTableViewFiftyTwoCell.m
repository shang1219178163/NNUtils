...
-(UILabel *)labelLeftPrefix{
    if (!_labelLeftPrefix) {
        _labelLeftPrefix = [UIView createLabelWithRect:CGRectZero text:@"" textColor:nil tag:kTAG_LABEL+5 type:@2 font:kFZ_Second backgroudColor:UIColor.themeColor alignment:NSTextAlignmentLeft];
    }
