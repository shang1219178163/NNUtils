...
-(UIButton *)btnOne{
    if (!_btnOne) {
        _btnOne = [UIButton createBtnWithRect:CGRectZero title:@"" font:kFZ_Second image:nil tag:kTAG_BTN type:@8 target:nil aSelector:nil];
    }
    return _btnOne;
}
...
-(UIButton *)btnTwo{
    if (!_btnTwo) {
        _btnTwo = [UIView createBtnWithRect:CGRectZero title:@"" font:kFZ_Second image:nil tag:kTAG_BTN+1 type:@7 target:nil aSelector:nil];
    }
    return _btnTwo;
}
