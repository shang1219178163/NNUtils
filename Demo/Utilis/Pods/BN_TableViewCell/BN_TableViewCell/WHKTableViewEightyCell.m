...
//    
//
//    CGSize labLeftSize = [self sizeWithText:self.labelLeft.text font:self.labelLeft.font width:kScreen_width - kX_GAP*2];
//    //控件2
//    CGRect labelLeftRect = CGRectMake(kX_GAP, kY_GAP, labLeftSize.width, labLeftSize.height);
//    self.labelLeft.frame = labelLeftRect;
//
//    CGRect viewRect = CGRectMake(kX_GAP, CGRectGetMaxY(labelLeftRect)+kY_GAP, kScreen_width - kX_GAP*2, 0);
//    self.itemsView.frame = viewRect;
//
//}
