...
-(UILabel *)labelSix{
    if (!_labelSix) {
        _labelSix = [UIView createLabelWithRect:CGRectZero text:@"" textColor:nil tag:kTAG_LABEL+5 type:@0 font:kFZ_Third backgroudColor:UIColor.whiteColor alignment:NSTextAlignmentCenter];
    }
    return _labelSix;
}
