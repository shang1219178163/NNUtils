...
- (void)createControls{
    ...
    //控件1
    UIButton * btn = [UIView createBtnWithRect:CGRectMake(0, 0, 20, 20) title:nil font:kFZ_Third image:nil tag:kTAG_BTN type:@3 target:self aSelector:@selector(handleActionBtn:)];
    ...
    //控件2
    UILabel * labTitle = [UIView createLabelWithRect:CGRectZero text:@"" textColor:nil tag:kTAG_LABEL type:@2 font:kFZ_Second backgroudColor:UIColor.whiteColor alignment:NSTextAlignmentLeft];
    [self.contentView addSubview:labTitle];

    //控件3
    UILabel * labRight = [UIView createLabelWithRect:CGRectZero text:@"" textColor:nil tag:kTAG_LABEL+1 type:@2 font:kFZ_Third backgroudColor:UIColor.whiteColor alignment:NSTextAlignmentRight];
