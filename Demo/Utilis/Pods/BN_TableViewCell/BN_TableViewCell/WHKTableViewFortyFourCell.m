...
@interface WHKTableViewFortyFourCell ()

@end

@implementation WHKTableViewFortyFourCell
...
-(UIImageView *)iConEP{
    if (!_iConEP) {
        _iConEP = [UIView createImgViewWithRect:CGRectZero image:@"icon_company.png" tag:kTAG_VIEW+1 type:@0];
    }
    return _iConEP;
}
