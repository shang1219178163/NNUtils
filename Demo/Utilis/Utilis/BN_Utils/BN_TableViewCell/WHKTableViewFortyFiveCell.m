...
@interface WHKTableViewFortyFiveCell ()

@end


@implementation WHKTableViewFortyFiveCell
...
-(void)layoutSubviews{
    ...
    //控件2
    CGRect labelLeftRect = CGRectMake(CGRectGetMaxX(iConRect) + padding, kY_GAP, kScreen_width - CGRectGetMaxX(iConRect) - padding - kX_GAP, kH_LABEL_SMALL);
    //控件3
...
-(UIImageView *)iConEP{
    if (!_iConEP) {
        _iConEP = [UIView createImgViewWithRect:CGRectZero image:@"icon_company.png" tag:kTAG_VIEW+2 patternType:@"0"];
    }
    return _iConEP;
}
