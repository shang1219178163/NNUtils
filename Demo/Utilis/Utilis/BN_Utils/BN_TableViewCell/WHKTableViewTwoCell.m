...
@interface WHKTableViewTwoCell ()

@end

@implementation WHKTableViewTwoCell
...
-(void)layoutSubviews{
    ...
    if (self.imgViewLeft.image){
        ...
        //控件1
        CGRect imgViewLeftRect = CGRectMake(kX_GAP, (self.height - imgViewLeftSize.height)/2.0, imgViewLeftSize.width, imgViewLeftSize.height);
        //控件3
        CGRect labelRightRect = CGRectMake(self.width - textSize.width - kY_GAP, kY_GAP, textSize.width, labelHeight);
        //控件2
        ...
        //控件4
        CGRect labelLeftSubRect = CGRectMake(CGRectGetMinX(labelLeftRect), CGRectGetMaxY(labelLeftRect), self.width - CGRectGetMaxX(imgViewLeftRect) - kY_GAP - kPadding, self.height - CGRectGetMaxY(labelLeftRect) - kY_GAP);
        ...
        //控件4
        CGRect labelLeftSubRect = CGRectMake(CGRectGetMinX(labelLeftRect), CGRectGetMaxY(labelLeftRect), self.width - kX_GAP*2, self.height - CGRectGetMaxY(labelLeftRect) - kY_GAP);
