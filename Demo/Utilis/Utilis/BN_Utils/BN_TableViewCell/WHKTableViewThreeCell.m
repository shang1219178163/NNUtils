...
@interface WHKTableViewThreeCell ()

@end

@implementation WHKTableViewThreeCell
...
-(void)layoutSubviews{
    ...
    CGRect imgViewRightRect = CGRectMake(self.width - arrowSize.width -  YGap, (self.height - arrowSize.height)/2.0, arrowSize.width, arrowSize.height);
