...
- (void)createControls{
    /*
     ...
     图片+文字
    */
    self.labViewOne = [[BN_LabView alloc]init];
    self.labViewTwo = [[BN_LabView alloc]init];
    self.labViewThree = [[BN_LabView alloc]init];
...
-(void)layoutSubviews{
    ...
    CGRect imgViewRightRect = CGRectMake(self.width - imgViewRightSize.width -  XYGap, (self.height - imgViewRightSize.height)/2.0, imgViewRightSize.width, imgViewRightSize.height);
