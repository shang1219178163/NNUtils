...
-(BN_TextField *)textFieldLeft{
    if (!_textFieldLeft) {
        _textFieldLeft = [UIView createTextFieldWithRect:CGRectZero text:@"" placeholder:nil font:KFZ_Second textAlignment:NSTextAlignmentCenter keyboardType:UIKeyboardTypeDefault];
...
-(BN_TextField *)textFieldCenter{
    if (!_textFieldCenter) {
        _textFieldCenter = [UIView createTextFieldWithRect:CGRectZero text:@"" placeholder:nil font:KFZ_Second textAlignment:NSTextAlignmentCenter keyboardType:UIKeyboardTypeDefault];
...
-(BN_TextField *)textFieldRight{
    if (!_textFieldRight) {
        _textFieldRight = [UIView createTextFieldWithRect:CGRectZero text:@"" placeholder:nil font:KFZ_Second textAlignment:NSTextAlignmentCenter keyboardType:UIKeyboardTypeDefault];
