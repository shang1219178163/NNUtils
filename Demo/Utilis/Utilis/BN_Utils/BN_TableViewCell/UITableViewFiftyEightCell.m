...
-(UILabel *)labelRightSub{
    if (!_labelRightSub) {
        _labelRightSub = [UIView createLabelWithRect:CGRectZero text:@"" textColor:nil tag:kTAG_LABEL+5 type:@2 font:kFZ_Third backgroudColor:UIColor.whiteColor alignment:NSTextAlignmentRight];
    }
