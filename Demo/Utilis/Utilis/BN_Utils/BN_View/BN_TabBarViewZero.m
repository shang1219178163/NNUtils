...
@interface BN_TabBarViewZero()<UIScrollViewDelegate>

@property (strong, nonatomic, readwrite) NSArray *items;

@end

@implementation BN_TabBarViewZero

+ (BN_TabBarViewZero *)viewWithRect:(CGRect)frame items:(NSArray *)items{
    BN_TabBarViewZero * view = [[BN_TabBarViewZero alloc]initWithFrame:frame items:items];
    return view;
