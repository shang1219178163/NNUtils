...
//        _segmentCtrl.tintColor = UIColor.cyanColor;
        ...
        [_segmentCtrl setDividerImage:UIImageFromColor(UIColor.whiteColor) forLeftSegmentState:UIControlStateNormal rightSegmentState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
    }
    return _segmentCtrl;
